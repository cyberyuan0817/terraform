...
#Team task role
task_role_arn = "arn:aws:iam::891377152553:role/ecsTaskExecutionRole"
ecr_image_link_prefix = "891377152553.dkr.ecr.ap-southeast-2.amazonaws.com"
aws_iam_user_id = "891377152553"


uat_ecr_repo_name = "paws-and-claws-ecr"
prod_ecr_repo_name = "paws-and-claws-prod-ecr"

host_web_address = "pawsnclawshotel.com.au"
